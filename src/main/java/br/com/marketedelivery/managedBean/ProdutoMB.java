...
public class ProdutoMB implements Serializable
{
	...
	{
		// Para consulta através do Web Service
		...
		try
		{
			...
			} else
			{
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage("O campo da imgem não pode ser invalido"));
				return;
			}
		}
		catch (Exception e)
	...
	// Métodos do Supermercado Carrefour
	...
	// Métodos do Supermercado Bompreço
