...
public class ControladorLoginFacebook implements Serializable
{
	...
	// Aqui define-se os atributos desejados para a classe extraídos do facebook
	...
	public Response executeFeed(final String url) throws Exception
	{
		if (accessGrant == null)
		{
			throw new SocialAuthException("Por favor, verificar a função de Resposta primeiro a receber Access Token");
		}
